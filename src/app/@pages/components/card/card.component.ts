import {
  ...
  export class pgCard {
    ...
    @ContentChild('CardTitle', /* TODO: add static flag */ {}) CardTitle: TemplateRef<void>;
    @ContentChild('CardExtraControls', /* TODO: add static flag */ {}) CardExtraControls: TemplateRef<void>;
    @Input()
